...
![Pipeline 批量收发](/public/redis/04-high-availability-chapter-06-pipeline-pubsub-1.svg)
...
![发布订阅广播架构](/public/redis/04-high-availability-chapter-06-pipeline-pubsub-2.svg)
