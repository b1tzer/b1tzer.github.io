...
> **与 Spring 微服务文档的分工**：本文聚焦架构理论和选型决策，具体的 Spring Cloud 组件原理和落地实践请参考 [Spring Cloud 核心组件](../spring/chapter-06-microservices.md) 和 [微服务架构深度实践](../spring/chapter-06-microservices.md)。
