...
>
> **前置阅读**：各核心组件的工作原理和配置方式请先参阅 → [Spring Cloud 核心组件](@spring-微服务与安全-Spring-Cloud核心组件)（Eureka / Gateway / Feign / Sentinel）
...
> 📖 **相关文档**：各核心组件原理速查 → [Spring Cloud 核心组件](@spring-微服务与安全-Spring-Cloud核心组件)