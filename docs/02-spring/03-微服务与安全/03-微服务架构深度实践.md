...
>
> **前置阅读**：各核心组件的工作原理和配置方式请先参阅 → [Spring Cloud 核心组件](./09-Spring-Cloud核心组件.md)（Eureka / Gateway / Feign / Sentinel）
...
> 关于 CAP 理论与 BASE 理论的详细说明，请参阅 → [CAP 理论与 BASE 理论](../../09-software-engineering/04-CAP理论与BASE理论.md)
...
> 📖 **相关文档**：各核心组件原理速查 → [Spring Cloud 核心组件](./09-Spring-Cloud核心组件.md)