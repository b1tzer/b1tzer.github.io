...
>
> **深入阅读**：落地实践（分布式事务、服务网格、K8s 部署、可观测性）请参阅 → [微服务架构深度实践](@spring-微服务与安全-微服务架构深度实践)
...
> 📖 **延伸阅读**：掌握组件原理后，进入落地实践 → [微服务架构深度实践](@spring-微服务与安全-微服务架构深度实践)（分布式事务、Seata、服务网格、K8s 部署、可观测性）